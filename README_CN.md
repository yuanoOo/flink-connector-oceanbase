...
|               Connector                |                                                                            描述                                                                             |                             使用文档                             |
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| Flink Connector: OceanBase             | 该Connector通过OceanBase支持的JDBC驱动从OceanBase读取数据或将数据写入OceanBase，支持MySQL 和 Oracle 兼容模式。Source 支持可配置分片策略的并行快照读取。                                                | [Source & Sink](docs/sink/flink-connector-oceanbase_cn.md)   |
